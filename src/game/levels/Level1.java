...
public class Level1 extends GameLevel{
    ...
    public Level1(Game game){
        ...
        Coins coin6 = new Coins(7,15,player1,this);
        Coins coin7 = new Coins(10,-5,player1,this);
        Coins coin8 = new Coins(10,-21,player1,this);
       // Lives life1= new Lives(10,22,player1,this);
        ...
        Weapon knife = new Weapon(-10,7,player1,this);

        // create the game platforms through the platform method
        Platform plat1 = new Platform(12,-23,this);
        Platform plat2 = new Platform(12,-13,this);
        Platform plat3 = new Platform(-10,-23,this);
        Platform plat4 = new Platform(0,-16,this);
        Platform plat5 = new Platform(12,-23,this);
        ...
        Platform plat15 = new Platform(-12,20,this);
        Platform plat16 = new Platform(-16,20,this);
        ...
        Enemy pred1
                = new Enemy(-4,-6,this,player1,new BodyImage("data/fireman.gif", 4f),3,3);
        pred1.setRANGE(3);
        pred1.setSPEED(3);

        Enemy pred2
                = new Enemy(0 ,-15,this,player1,new BodyImage("data/fireman.gif", 4f),3,3);
        pred2.setRANGE(3);
        pred2.setSPEED(3);

        Enemy pred3
                = new Enemy(10 ,2,this,player1,new BodyImage("data/fireman.gif", 4f),3,3);
        pred3.setRANGE(3);
        pred3.setSPEED(3);
